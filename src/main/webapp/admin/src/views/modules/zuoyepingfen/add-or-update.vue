  ...
  <div class="addEdit-block">
    ...
    >
      <el-row>
          ...
          <el-form-item class="input" label="作业成绩" prop="zuoyechengji">
              <el-input v-model="ruleForm.zuoyechengji" 
                placeholder="作业成绩" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="作业状态" prop="zuoyezhuangtai">
          <el-select v-model="ruleForm.zuoyezhuangtai" placeholder="请选择作业状态">
            <el-option
                v-for="(item,index) in zuoyezhuangtaiOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="作业状态" prop="zuoyezhuangtai">
	      <el-input v-model="ruleForm.zuoyezhuangtai"
                placeholder="作业状态" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                              </el-row>
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zuoyechengji = true;
            continue;
	            	            ...
	            	            if(o=='zuoyezhuangtai'){
            this.ruleForm.zuoyezhuangtai = obj[o];
	    this.ro.zuoyezhuangtai = true;
            continue;
          }
	                    }
                                                                                                                              }
          ...
          this.$message.error(data.msg);
              ...
              if (data && data.code === 0) {
                ...
                this.$message.error(data.msg);
                                                                                                                ...
                                                                                                                this.zuoyezhuangtaiOptions = "及格,不及格".split(',')
                            },
                    // 下二随
    xuehaoChange () {
      this.$http({
